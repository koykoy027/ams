...
if (isset($_POST['updateCurrentJob'])) {

  $current_job = $_POST['current_job'];
  $current_company = $_POST['current_company'];
  $job_status = $_POST['job_status'];

  $query = "UPDATE users SET job_status = '$job_status', current_company='$current_company', current_job='$current_job' WHERE email='$update_email'";
  $query_run = mysqli_query($conn, $query);

  if ($query_run) {
    $messageCurrentJob = 'Your changes has been successfully saved!';
    ...
    echo '<script type="text/javascript">alert("Your changes has been failed!", "Failed!")</script>';
  }
}
...
if (isset($_POST['updateInformation'])) {
  ...
  $query = "UPDATE users SET course='$select_option', firstname='$update_firstname', lastname='$update_lastname',birthday='$update_birthday',home_address='$update_address', year_graduate='$update_year_graduate' , bio = '$bio', current_job='$current_job' WHERE email='$update_email'";
  $query_run = mysqli_query($conn, $query);

  if ($query_run) {
    $messageInformation = 'Your changes has been successfully saved!';
...
if (isset($_POST['updateContacts'])) {
  ...
  $query = "UPDATE users SET facebook='$facebook', instagram='$instagram', personal_website='$personal_website' WHERE email='$update_email'";
  $query_run = mysqli_query($conn, $query);

  if ($query_run) {
    $messageContacts = 'Your changes has been successfully saved!';
...
if (isset($_POST['updateEducation'])) {
  ...
  $query = "UPDATE users SET secondary='$secondary', primary_='$primary_' WHERE email='$update_email'";
  $query_run = mysqli_query($conn, $query);

  if ($query_run) {
    $messageEducation = 'Your changes has been successfully saved!';
    $sql = "SELECT * FROM users WHERE email='$update_email'";
...
<body class="d-flex flex-column">
  <main class="flex-shrink-0">
    ...
    <!-- current job -->
    <form class="py-5" id="scroll-target" method="POST" enctype="multipart/form-data">
      <div class=" container px-5 my-5">
        <div class="row gx-5">
          <div class="col-lg-3">
            <h2 class="fw-bolder">
          ...
          <div class="col-lg">
            ...
            <hr>
            <div class="row">
              <?php if (!empty($messageCurrentJob)) : ?>
                <div class="alert alert-success alert-dismissible" role="alert">
                  <?php echo $messageCurrentJob; ?>
                </div>
              <?php endif; ?>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-end">
          <button type="submit" name="updateCurrentJob" class="btn btn-primary">Save Changes</button>
        </div>
      </div>
    </form>

    <!-- information -->
    <form class="py-5 bg-light" id="scroll-target" method="POST" enctype="multipart/form-data">
      <div class="container px-5 my-5">
        <div class="row gx-5">
          <div class="col-lg-3">
            <h2 class="fw-bolder">
          ...
          <div class="col-lg">
            ...
            <hr>
            <div class="row">
              <?php if (!empty($messageInformation)) : ?>
                <div class="alert alert-success alert-dismissible" role="alert">
                  <?php echo $messageInformation; ?>
                </div>
              <?php endif; ?>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-end">
          <button type="submit" name="updateInformation" class="btn btn-primary">Save Changes</button>
        </div>
      ...
      <div class="container px-5 my-5">
        <div class="row gx-5">
          ...
          <div class="col-lg">
            ...
            <div class="row mx-3">
              <?php if (!empty($messageContacts)) : ?>
                <div class="alert alert-success alert-dismissible" role="alert">
                  <?php echo $messageContacts; ?>
                </div>
              <?php endif; ?>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-end mx-3">
          <button type="submit" name="updateContacts" class="btn btn-primary">Save Changes</button>
        </div>
      ...
      <div class="container px-5 my-5">
        <div class="row gx-5">
          ...
          <div class="col-lg">
            ...
            <div class="row mx-3">
              <?php if (!empty($messageEducation)) : ?>
                <div class="alert alert-success alert-dismissible" role="alert">
                  <?php echo $messageEducation; ?>
                </div>
              <?php endif; ?>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-end mx-3">
          <button type="submit" name="updateEducation" class="btn btn-primary">Save Changes</button>
        </div>
